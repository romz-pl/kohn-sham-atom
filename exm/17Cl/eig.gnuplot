...
set output 'eig-Cl-1s2.png'
set title "Eigenfunction 1s2 for Cl atom"
set xrange[0:0.6]
set xtics 0.1
plot "eig.dat.1s2" using 1:2 with lines title 'State 1s2' lw 4 lc rgb "#00FF00", 

set output 'eig-Cl-2s2.png'
set title "Eigenfunction 2s2 for Cl atom"
set xrange[0:1.5]
set xtics 0.5
plot "eig.dat.2s2" using 1:2 with lines title 'State 2s2' lw 4 lc rgb "#00FF00",

set output 'eig-Cl-2p6.png'
set title "Eigenfunction 2p6 for Cl atom"
set xrange[0:2]
set xtics 0.5
plot "eig.dat.2p6" using 1:2 with lines title 'State 2p6' lw 4 lc rgb "#00FF00",

set output 'eig-Cl-3s2.png'
set title "Eigenfunction 3s2 for Cl atom"
set xrange[0:5]
set xtics 1
plot "eig.dat.3s2" using 1:2 with lines title 'State 3s2' lw 4 lc rgb "#00FF00",

set output 'eig-Cl-3p5.png'
set title "Eigenfunction 3p5 for Cl atom"
set xrange[0:8]
set xtics 1
plot "eig.dat.3p5" using 1:2 with lines title 'State 3p5' lw 4 lc rgb "#00FF00",
